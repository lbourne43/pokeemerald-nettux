...
#define B_WEATHER_NETTUX_ACID_RAIN (1 << BATTLE_WEATHER_NETTUX_ACID_RAIN)
#define B_WEATHER_NETTUX_BLACKOUT  (1 << BATTLE_WEATHER_NETTUX_BLACKOUT)

#define B_WEATHER_ANY           (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_HAIL | B_WEATHER_STRONG_WINDS | B_WEATHER_SNOW | B_WEATHER_FOG | B_WEATHER_NETTUX_ACID_RAIN | B_WEATHER_NETTUX_BLACKOUT)
