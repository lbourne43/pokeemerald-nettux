...
{
    [BALL_TOP_FIRST]        = {SPECIES_MUDKIP, 5, ITEM_MYSTIC_WATER, BALL_POKE, NATURE_JOLLY, 2, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_GROWL, MOVE_TACKLE, MOVE_WATER_GUN, MOVE_YAWN}, 0, 0, 1},
    [BALL_TOP_SECOND]       = {SPECIES_TREECKO, 5, ITEM_MIRACLE_SEED, BALL_POKE, NATURE_TIMID, 2, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_LEER, MOVE_POUND, MOVE_ABSORB, MOVE_LEECH_SEED}, 0, 0, 1},
    [BALL_MIDDLE_FIRST]     = {SPECIES_GASTLY, 5, ITEM_POISON_BARB, BALL_POKE, NATURE_TIMID, 1, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_CONFUSE_RAY, MOVE_LICK, MOVE_HYPNOSIS, MOVE_CLEAR_SMOG}, 0, 0, 1},

    [BALL_TOP_THIRD]        = {SPECIES_TORCHIC, 5, ITEM_CHARCOAL, BALL_POKE, NATURE_JOLLY, 2, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_GROWL, MOVE_SCRATCH, MOVE_EMBER, MOVE_PECK}, 0, 0, 1},
    [BALL_TOP_FOURTH]       = {SPECIES_RALTS, 5, ITEM_FAIRY_FEATHER, BALL_POKE, NATURE_TIMID, 2, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_GROWL, MOVE_DOUBLE_TEAM, MOVE_DISARMING_VOICE, MOVE_MEAN_LOOK}, 0, 0, 1},
    [BALL_MIDDLE_THIRD]     = {SPECIES_MAREEP, 5, ITEM_MAGNET, BALL_POKE, NATURE_TIMID, 1, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_GROWL, MOVE_TACKLE, MOVE_THUNDER_WAVE, MOVE_ELECTROWEB}, 0, 0, 1},

    [BALL_MIDDLE_SECOND]    = {SPECIES_BELDUM, 5, ITEM_METAL_COAT, BALL_POKE, NATURE_JOLLY, 0, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_TAKE_DOWN, MOVE_TACKLE, MOVE_METAL_CLAW, MOVE_IRON_DEFENSE}, 0, 0, 1},
    [BALL_BOTTOM_FIRST]     = {SPECIES_GIBLE, 5, ITEM_SOFT_SAND, BALL_POKE, NATURE_JOLLY, 2, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_SAND_TOMB, MOVE_TACKLE, MOVE_METAL_CLAW, MOVE_TWISTER}, 0, 0, 1},
    [BALL_BOTTOM_SECOND]    = {SPECIES_ABRA, 5, ITEM_TWISTED_SPOON, BALL_POKE, NATURE_TIMID, 2, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_TELEPORT, MOVE_CONFUSION, MOVE_GUARD_SPLIT, MOVE_MAGIC_COAT}, 0, 0, 1},
};
